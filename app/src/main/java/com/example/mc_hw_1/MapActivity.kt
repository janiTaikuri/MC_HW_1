...
class MapActivity : AppCompatActivity(), OnMapReadyCallback{
    ...
    private fun createGeofence(
        ...
        val geofenceRequest = GeofencingRequest.Builder()
            .setInitialTrigger(Geofence.GEOFENCE_TRANSITION_ENTER).addGeofence(geofence).build()
        ...
        gMap.setOnMapClickListener{ location: LatLng ->
            with(gMap){
                ...
                addCircle(CircleOptions().center(location)
                    .strokeColor(Color.argb(50, 70, 70, 70)).fillColor(Color.argb(100, 150, 150, 150)))
